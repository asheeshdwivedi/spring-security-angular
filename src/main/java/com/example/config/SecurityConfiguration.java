...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler)
                ...
                .antMatchers("/index.html","/forgotPassword","/resetPassword/**","/send-mail/**/*" , "/" ,"/login"
                        ,"/auth/*","/partials/login.html","/partials/forgotPassword.html","/partials/resetPassword.html"
                        ,"/partials/common/*","/vendor/**/**/*" ,"/partials/directives/*").permitAll().anyRequest().authenticated();
    }
